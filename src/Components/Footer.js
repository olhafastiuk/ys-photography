  ...
  return (
    <footer>
      ...
      <Flex align="center">
        ...
        >
          <LinK to="/">
            <img className="logo" src={logo} style={{ width: "8rem" }} alt="" />
          </LinK>
        </Flex>
        ...
        >
          <LinK to="/">
            <p className="footerLink">Головна</p>
          </LinK>
          <LinK to="/about">
            <p className="footerLink">Про мене</p>
          </LinK>
          <LinK to="/gallery">
            <p className="footerLink">Галерея</p>
          </LinK>
          <LinK to="/price">
            <p className="footerLink">Пакети послуг</p>
          </LinK>
          <LinK to="/contacts">
            <p className="footerLink">Контакти</p>
          </LinK>
        </Flex>
